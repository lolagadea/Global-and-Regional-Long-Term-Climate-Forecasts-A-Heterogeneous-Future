function [Xf, SBIC]=arp20_roll_forecast_h(Y,years,names,f,w)
...
print(f,strcat('Figure_arp20_roll_',f2,'_',w2), '-dpdf')
print(f,strcat('Figure_arp20_roll_',f2,'_',w2), '-deps')

save(strcat(f2,'_',w2,'_arp20_roll.dat'),'Xf','-ASCII');