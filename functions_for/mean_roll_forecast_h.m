function [Xf, SBIC]=mean_roll_forecast_h(Y,years,names,f,w)
...
print(f,strcat('Figure_mean_roll_',f2,'_',w2), '-dpdf')
print(f,strcat('Figure_mean_roll_',f2,'_',w2), '-deps')


save(strcat(f2,'_',w2,'_mean_roll.dat'),'Xf','-ASCII');