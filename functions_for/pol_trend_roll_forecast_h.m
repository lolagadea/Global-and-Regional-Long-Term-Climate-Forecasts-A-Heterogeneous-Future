function [Xf,K, SBIC]=pol_trend_roll_forecast_h(Y,years,names,f,w)
[t,n]=size(Y);
...
print(f,strcat('Figure_pol_trend_roll_',f2,'_',w2), '-dpdf')
print(f,strcat('Figure_pol_trend_roll_',f2,'_',w2), '-deps')
