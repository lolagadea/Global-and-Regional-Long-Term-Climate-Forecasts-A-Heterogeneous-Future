...
%
% Location:
%   02_Globe/Forecast/run_forecast_competition
%
...
%
% This code computes the rolling forecast competition for the full sample
% used in the main forecasting exercise.
% ========================================================================
...
for j = 1:length(w)
    ...
    for i = 1:length(h)
        ...
        % ----------------------------------------------------------------
        % NOTE:
        % This model may require additional break-search routines.
        % If it fails, first check that all break-related functions have
        % been copied to functions_for.
        ...
        % ----------------------------------------------------------------
        % NOTE:
        % This model may depend on external ARFIMA routines/toolboxes.
        % If it fails, we will isolate its dependencies separately.
...
OUT_FILE = fullfile(RES_DIR, 'RDOS_Globe_1880_2023.mat');
save(OUT_FILE, 'RDOS');
