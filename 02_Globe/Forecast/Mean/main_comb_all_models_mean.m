% ========================================================================
% main_comb_all_models_mean.m
% ------------------------------------------------------------------------
% Long-term forecasts for the global mean using all individual models and
...
for u = 1:length(S)
    ...
    for v = 1:length(F)
        ...
        comb0(u,v) = Weights_BIC(u,:)*squeeze(RDOS(:,u,v));
        Weig0 = Weights_BIC(u,:);
    ...
    TAB_FILE = fullfile(TAB_DIR, ...
        'table_forecast_comb_all_mean_Globe_1880_2023.tex');
    ...
    % --------------------------------------------------------------------
    % 5. Display reference values
    % --------------------------------------------------------------------
    
    disp('The average value of the mean in the full sample is:')
    mean(y)
    
    disp('The average value of the mean in 1880-1900 is:')
    mean(y(1:21))
    
    disp('The average value of the mean in 1986-2005 is:')
    mean(y(107:126))
    
    disp('The average value of the mean in 1995-2014 is:')
    mean(y(116:135))
    
    disp('The last value of the mean in the sample is:')
    mean(y(end))
...
if isfile(RDOS_FILE)
    ...
    figfile = fullfile(FIG_DIR,'Figure_for_mean_comb_all_Globe_1880_2023');
...
fprintf('\nCombined forecasts for the global mean completed.\n');
