...
% analysis_q95_SBIC.m
% ------------------------------------------------------------------------
% Analysis of SBIC selection and long-run forecasts for the global q95.
% ========================================================================
...
TAB_FILE = fullfile(TAB_DIR,'Table_q95_SBIC_Globe_1880_2023.tex');
...
TAB_FILE2 = fullfile(TAB_DIR,'Table_q95_forecast_Globe_1880_2023.tex');
...
save(fullfile(RES_DIR,'RDOS_for_q95_Globe_1880_2023.mat'),'RDOS');

fprintf('\nq95 SBIC analysis completed.\n');
