...
for u = 1:length(S)
    ...
    TAB_FILE = fullfile(TAB_DIR, ...
        'table_forecast_comb_all_q95_Globe_1880_2023.tex');
...
if isfile(RDOS_FILE)
    ...
    figfile = fullfile(FIG_DIR,'Figure_for_q95_comb_all_Globe_1880_2023');
...
fprintf('\nCombined forecasts for the global q95 completed.\n');
