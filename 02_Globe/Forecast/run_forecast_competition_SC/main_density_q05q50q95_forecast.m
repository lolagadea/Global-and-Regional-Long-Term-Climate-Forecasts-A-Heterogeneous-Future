% ========================================================================
% main_density_q05q50q95_forecast.m
% ------------------------------------------------------------------------
% Joint model selection using q05, q50 and q95.
%
% Inputs:
...
%
% Outputs:
%   Results_for/selected_the_model_q05q50q95.mat
%   Results_for/selected_the_model2_q05q50q95.mat
% ========================================================================
...
% ------------------------------------------------------------------------
% 4. Select the best model by aggregate RMSE
% ------------------------------------------------------------------------
...
% ------------------------------------------------------------------------
% 5. GW test using aggregate loss
% ------------------------------------------------------------------------
...
save(fullfile(RES_DIR,'selected_the_model_q05q50q95.mat'), ...
    'MODELS');

save(fullfile(RES_DIR,'selected_the_model2_q05q50q95.mat'), ...
    'MODELS2');

fprintf('\nJoint q05-q50-q95 model selection completed.\n');
