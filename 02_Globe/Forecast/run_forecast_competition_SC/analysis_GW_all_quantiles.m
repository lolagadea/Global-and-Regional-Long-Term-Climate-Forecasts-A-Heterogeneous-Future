...
RDOS_FILE = fullfile(RES_DIR, 'RDOS_Globe_1880_1960.mat');

assert(isfile(DATA_FILE), 'Input quantiles file not found.');
assert(isfile(RDOS_FILE), 'RDOS_Globe_1880_1960.mat not found.');
...
for wi = 1:length(W)
    ...
    warning('Skipping incompatible combination: t=%d, w=%d, h=%d', t, w, f);
    continue
