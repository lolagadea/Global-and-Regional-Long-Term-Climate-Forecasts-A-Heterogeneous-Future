% ========================================================================
% main_density_all_charact_forecast.m
% ------------------------------------------------------------------------
% Joint model selection using all selected temperature characteristics.
%
% Inputs:
%   Results_for/GW_rdos_for*_w*_all_quantiles.mat
%   02_Globe/Introduction/Results/QUANTILES_monthly_Globe_1880_1960.mat
%
% Outputs:
%   Results_for/selected_the_model_allchar.mat
%   Results_for/selected_the_model2_allchar.mat
% ========================================================================
...
% ------------------------------------------------------------------------
% 4. Select the best model by aggregate RMSE across all characteristics
% ------------------------------------------------------------------------
...
% ------------------------------------------------------------------------
% 5. GW test using aggregate loss across all selected characteristics
% ------------------------------------------------------------------------
...
save(fullfile(RES_DIR,'selected_the_model_allchar.mat'),  'MODELS');
save(fullfile(RES_DIR,'selected_the_model2_allchar.mat'), 'MODELS2');

fprintf('\nJoint all-characteristics model selection completed.\n');
