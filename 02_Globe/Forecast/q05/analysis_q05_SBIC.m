...
% analysis_q05_SBIC.m
% ------------------------------------------------------------------------
% Analysis of SBIC selection and long-run forecasts for the global q05.
% ========================================================================
...
TAB_FILE = fullfile(TAB_DIR,'Table_q05_SBIC_Globe_1880_2023.tex');
...
TAB_FILE2 = fullfile(TAB_DIR,'Table_q05_forecast_Globe_1880_2023.tex');
...
save(fullfile(RES_DIR,'RDOS_for_q05_Globe_1880_2023.mat'),'RDOS');

fprintf('\nq05 SBIC analysis completed.\n');
