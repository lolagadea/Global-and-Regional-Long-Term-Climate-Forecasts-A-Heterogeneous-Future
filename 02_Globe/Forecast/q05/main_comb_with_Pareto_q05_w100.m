% ========================================================================
% main_comb_with_Pareto_q05_w100.m
% ------------------------------------------------------------------------
% Forecast combinations for the global q05 using Pareto-superior models.
% Window: w = 100.
% ========================================================================
...
for v = 1:length(Q)
    ...
    figfile = fullfile(FIG_DIR, ...
        'Figure_for_q05_comb_Pareto_Globe_1880_2023_w100');
...
TAB_FILE_FOR = fullfile(TAB_DIR, ...
    'Table_forecast_Pareto_q05_ci_for_w100_Globe_1880_2023.tex');
...
TAB_FILE_FIT = fullfile(TAB_DIR, ...
    'Table_forecast_Pareto_q05_ci_fit_w100_Globe_1880_2023.tex');
...
RDOS_q05.comb_Pareto.H = F;
RDOS_q05.comb_Pareto.W = W;
RDOS_q05.comb_Pareto.models = models;
RDOS_q05.comb_Pareto.forecast = FORECAST_table;
RDOS_q05.comb_Pareto.ci.fit = CI_fit_table;
RDOS_q05.comb_Pareto.ci.for = CI_for_table;
RDOS_q05.comb_Pareto.selected = SELECTED;
RDOS_q05.comb_Pareto.RDOS_df = RDOS_df;

RDOS = RDOS_q05;

save(RDOS_FILE,'RDOS');

fprintf('\nPareto-combined forecasts for the global q05 completed.\n');
