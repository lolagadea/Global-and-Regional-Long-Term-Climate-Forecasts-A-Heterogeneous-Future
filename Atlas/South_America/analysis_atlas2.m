...
% ------------------------------------------------------------------------
% Density forecasts vs Atlas projections: South America.
% Portable version.
% ========================================================================
...
FORECAST_RES_DIR = fullfile(CODES_DIR, ...
    '03 Regional','Forecast','SouthAm','Results_for');

load(fullfile(FORECAST_RES_DIR, ...
    'for_2100_SouthAm_1960_2023.mat'))
for_2100 = FOR_comb.m2.for;

load(fullfile(FORECAST_RES_DIR, ...
    'RDOS_FIT_allQ_method2_w25_SouthAm_1960_2023.mat'))
for_2050 = RDOS_FIT(:,1,1,3);

load TEMP_2006_2100_South_America_rcp26
atlas_2048_r26 = TEMP.data.yearly(43);
atlas_2100_r26 = TEMP.data.yearly(95);

load TEMP_2006_2100_South_America_rcp45
atlas_2048_r45 = TEMP.data.yearly(43);
atlas_2100_r45 = TEMP.data.yearly(95);

load TEMP_2006_2100_South_America_rcp85
...
OUT_NAME = fullfile(FIG_DIR,'Figure_atlas_SouthAm');
