% ========================================================================
% read_file_historical_CMIP6_1850_2014.m
% ------------------------------------------------------------------------
...
% ------------------------------------------------------------------------
NC_FILE = fullfile(DATA_DIR, 't_CMIP6_historical_mon_185001-201412.nc');
OUT_FILE = fullfile(RESULTS_DIR, 'TEMP_CMIP6_historical_mon_185001_201412.mat');
...
years=[years(2:end);2014]; months=[months(2:end);12];
...
M_years=NaN(nyears,nmodels);
for i=1:nyears
    M_years(i,:)=mean(M_months((i-1)*12+1:i*12,:));
end
...
plot(years2,nanmean(M_years,2),'LineWidth',2)
for i=1:nmodels
    hold on
    plot(years2,M_years(:,i),'Color','b','LineStyle','--')
end
hold off
