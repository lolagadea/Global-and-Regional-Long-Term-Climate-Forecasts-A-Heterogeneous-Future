...
% read_file_rcp26.m
% ------------------------------------------------------------------------
% Reads CMIP5 RCP2.6 NetCDF data and constructs global temperature series.
% Portable version.
% ========================================================================
...
% 2. Input NetCDF file
% ------------------------------------------------------------------------
NC_FILE = fullfile(DATA_DIR, ...
    't_CMIP5_rcp26_mon_200601-210012.nc');
...
years  = [years(2:end); 2100];
months = [months(2:end); 12];

% ------------------------------------------------------------------------
% 5. Replace missing values by NaN
% ------------------------------------------------------------------------
...
% ------------------------------------------------------------------------
% 6. Latitude-weighted global monthly average
% ------------------------------------------------------------------------
w = cos(lat*pi/180);
w = w / sum(w);
...
OUT_FILE = fullfile(RESULTS_DIR, ...
    'TEMP_2006_2100_CMIP5_Globe_rcp26.mat');
