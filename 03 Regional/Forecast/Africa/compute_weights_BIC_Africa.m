% ========================================================================
% compute_weights_BIC_Africa.m
% ------------------------------------------------------------------------
% Compute BIC weights for Africa temperature characteristics.
...
%
% Outputs:
%   03_Regional/Forecast/Africa/Results_for/Weights_BIC_Africa.dat
%   03_Regional/Forecast/Africa/Results_for/BIC_Africa.dat
% ========================================================================
...
save(fullfile(OUT_RES_DIR,'Weights_BIC_Africa.dat'),'W','-ASCII');
save(fullfile(OUT_RES_DIR,'BIC_Africa.dat'),'SBIC','-ASCII');