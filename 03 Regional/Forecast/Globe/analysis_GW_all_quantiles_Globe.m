% ========================================================================
% analysis_GW_all_quantiles_Globe.m
% ------------------------------------------------------------------------
% Giacomini-White pairwise forecast comparison tests for Globe.
% Replication package IJF - Regional Forecast module.
%
% Inputs:
%   03_Regional/Introduction/Results/QUANTILES_monthly_1960_2023.mat
%   03_Regional/Forecast/Globe/Results_for/RDOS_Globe_1960_2023.mat
%
% Outputs:
%   03_Regional/Forecast/Globe/Results_for/GW_rdos_for*_w25_all_quantiles.mat
% ========================================================================
...
RDOS_FILE  = fullfile(OUT_RES_DIR,'RDOS_Globe_1960_2023.mat');
...
assert(exist(RDOS_FILE,'file')==2, ...
    'RDOS_Globe_1960_2023.mat not found in Globe/Results.');
...
for wi = 1:length(W)
    ...
    for fi = 1:length(F)
        ...
        fprintf('GW tests: Globe, window = %d, horizon = %d\n', w, f);
