% ========================================================================
% main_density_all_quantiles_forecast_Australia.m
% ------------------------------------------------------------------------
% Selection of Pareto-superior models for the density forecast exercise
% using all selected quantiles for Australia.
% ========================================================================
...
assert(isfile(RDOS_FILE), ...
    'RDOS_Australia_1960_2023.mat not found.');
...
Z = QUANTILES_monthly.Australia(:,q);
t = size(Z,1);
...
for j = 1:length(W)
    ...
    for i = 1:length(F)
        ...
        fprintf('Density GW tests: Australia, window = %d, horizon = %d\n',w,f);
...
save(fullfile(RES_DIR,'selected_model_allQ_Australia.mat'), ...
