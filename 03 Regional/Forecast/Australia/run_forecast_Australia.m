% ========================================================================
% run_forecast_Australia.m
% ------------------------------------------------------------------------
% Forecast competition for Australia temperature distribution characteristics.
...
THIS_DIR     = fileparts(mfilename('fullpath'));   % .../03_Regional/Forecast/Australia
...
for j = 1:length(w)
    ...
    for i = 1:length(h)
        ...
        fprintf('\nRunning Australia: window = %d, horizon = %d\n', w(j), h(i));
...
OUT_FILE = fullfile(RES_DIR,'RDOS_Australia_1960_2023.mat');
save(OUT_FILE,'RDOS');
...
fprintf('\nForecast competition completed for Australia.\n');
