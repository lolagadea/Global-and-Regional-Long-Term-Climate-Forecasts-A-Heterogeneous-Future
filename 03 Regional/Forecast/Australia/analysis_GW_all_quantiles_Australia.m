% ========================================================================
% analysis_GW_all_quantiles_Australia.m
% ------------------------------------------------------------------------
% Giacomini-White pairwise forecast comparison tests for Australia.
% Replication package IJF - Regional Forecast module.
%
% Inputs:
%   03_Regional/Introduction/Results/QUANTILES_monthly_1960_2023.mat
%   03_Regional/Forecast/Australia/Results_for/RDOS_Australia_1960_2023.mat
%
% Outputs:
%   03_Regional/Forecast/Australia/Results_for/GW_rdos_for*_w25_all_quantiles.mat
% ========================================================================
...
RDOS_FILE  = fullfile(OUT_RES_DIR,'RDOS_Australia_1960_2023.mat');
...
assert(exist(RDOS_FILE,'file')==2, ...
    'RDOS_Australia_1960_2023.mat not found in Australia/Results.');

load(QUANT_FILE,'QUANTILES_monthly','name_labels');
load(RDOS_FILE,'RDOS');

Z = QUANTILES_monthly.Australia;
...
for wi = 1:length(W)
    ...
    for fi = 1:length(F)
        ...
        fprintf('GW tests: Australia, window = %d, horizon = %d\n', w, f);
