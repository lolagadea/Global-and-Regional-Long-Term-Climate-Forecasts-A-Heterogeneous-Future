% ========================================================================
% analysis_GW_all_quantiles_Asia.m
% ------------------------------------------------------------------------
% Giacomini-White pairwise forecast comparison tests for Asia.
% Replication package IJF - Regional Forecast module.
%
% Inputs:
%   03_Regional/Introduction/Results/QUANTILES_monthly_1960_2023.mat
%   03_Regional/Forecast/Asia/Results_for/RDOS_Asia_1960_2023.mat
%
% Outputs:
%   03_Regional/Forecast/Asia/Results_for/GW_rdos_for*_w25_all_quantiles.mat
% ========================================================================
...
RDOS_FILE  = fullfile(OUT_RES_DIR,'RDOS_Asia_1960_2023.mat');
...
assert(exist(RDOS_FILE,'file')==2, ...
    'RDOS_Asia_1960_2023.mat not found in Asia/Results.');

load(QUANT_FILE,'QUANTILES_monthly','name_labels');
load(RDOS_FILE,'RDOS');

Z = QUANTILES_monthly.Asia;
...
for wi = 1:length(W)
    ...
    for fi = 1:length(F)
        ...
        fprintf('GW tests: Asia, window = %d, horizon = %d\n', w, f);
