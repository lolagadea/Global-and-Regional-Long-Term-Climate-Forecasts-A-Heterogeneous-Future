% ========================================================================
% main_density_forecast_Pareto_allQ_w25_method1_Asia.m
% ------------------------------------------------------------------------
% Density forecasts using Pareto-superior models, all selected quantiles.
% Region: Asia. Window: w = 25. Method 1.
% ========================================================================
...
BIC_FILE  = fullfile(RES_DIR,'BIC_Asia.dat');
...
assert(isfile(RDOS_FILE),   'RDOS_Asia_1960_2023.mat not found.');
assert(isfile(BIC_FILE),    'BIC_Asia.dat not found.');
...
QUANTILES = QUANTILES_monthly.Asia;
...
for j = 1:length(W)
    ...
    for i = 1:length(F)
        ...
        for q = 1:length(Q)
            ...
            fprintf('Method 1: Asia, h=%d, quantile index=%d\n',f,Q(q));
...
tableCaption = ['Long-term density forecast with Pareto superior model ' ...
    'for all quantiles (Asia, CRU data, 1960--2023, w=25, method1)'];

tableLabel = 'tab-Pareto-one-model-all-quantiles-method1-Asia-1960-2023';

file = fullfile(TAB_DIR, ...
    'Table_onemodel_allquantiles_w25_method1_for_Asia_1960_2023.tex');
...
file = fullfile(TAB_DIR, ...
    'Table_onemodel_allquantiles_w25_method1_fit_Asia_1960_2023.tex');
...
save(fullfile(RES_DIR,'RDOS_FOR_allQ_method1_w25_Asia_1960_2023.mat'), ...
    'RDOS_FOR');

save(fullfile(RES_DIR,'RDOS_FIT_allQ_method1_w25_Asia_1960_2023.mat'), ...
    'RDOS_FIT');

fprintf('\nDensity forecast method1 completed for Asia.\n');
