% ========================================================================
% compute_weights_BIC_Asia.m
% ------------------------------------------------------------------------
% Compute BIC weights for Asia temperature characteristics.
...
%
% Outputs:
%   03_Regional/Forecast/Asia/Results_for/Weights_BIC_Asia.dat
%   03_Regional/Forecast/Asia/Results_for/BIC_Asia.dat
% ========================================================================
...
save(fullfile(OUT_RES_DIR,'Weights_BIC_Asia.dat'),'W','-ASCII');
save(fullfile(OUT_RES_DIR,'BIC_Asia.dat'),'SBIC','-ASCII');