% ========================================================================
% compute_weights_BIC_Antarctic.m
% ------------------------------------------------------------------------
% Compute BIC weights for Antarctic temperature characteristics.
...
%
% Outputs:
%   03_Regional/Forecast/Antarctic/Results_for/Weights_BIC_Antarctic.dat
%   03_Regional/Forecast/Antarctic/Results_for/BIC_Antarctic.dat
% ========================================================================
...
save(fullfile(OUT_RES_DIR,'Weights_BIC_Antarctic.dat'),'W','-ASCII');
save(fullfile(OUT_RES_DIR,'BIC_Antarctic.dat'),'SBIC','-ASCII');