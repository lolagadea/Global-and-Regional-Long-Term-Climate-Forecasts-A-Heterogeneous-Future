% ========================================================================
% main_density_all_quantiles_forecast_Antarctic.m
% ------------------------------------------------------------------------
% Selection of Pareto-superior models for the density forecast exercise
% using all selected quantiles for Antarctic.
% ========================================================================
...
assert(isfile(RDOS_FILE), ...
    'RDOS_Antarctic_1960_2023.mat not found.');
...
for j = 1:length(W)
    ...
    for i = 1:length(F)
        ...
        fprintf('Density GW tests: Antarctic, window = %d, horizon = %d\n',w,f);
...
save(fullfile(RES_DIR,'selected_model_allQ_Antarctic.mat'), ...
