% ========================================================================
% main_density_forecast_Pareto_allQ_w25_method1_Antarctic.m
% ------------------------------------------------------------------------
% Density forecasts using Pareto-superior models, all selected quantiles.
% Region: Antarctic. Window: w = 25. Method 1.
% ========================================================================
...
RDOS_FILE = fullfile(RES_DIR,'RDOS_Antarctic_1960_2023.mat');
BIC_FILE  = fullfile(RES_DIR,'BIC_Antarctic.dat');
...
assert(isfile(RDOS_FILE),   'RDOS_Antarctic_1960_2023.mat not found.');
assert(isfile(BIC_FILE),    'BIC_Antarctic.dat not found.');
...
QUANTILES = QUANTILES_monthly.ANC;
RDOS_run_comp = RDOS;
...
for j = 1:length(W)
    ...
    for i = 1:length(F)
        ...
        for q = 1:length(Q)
            ...
            fprintf('Method 1: Antarctic, h=%d, quantile index=%d\n',f,Q(q));
...
tableCaption = ['Long-term density forecast with Pareto superior model ' ...
    'for all quantiles (Antarctic, CRU data, 1960--2023, w=25, method1)'];

tableLabel = 'tab-Pareto-one-model-all-quantiles-method1-Antarctic-1960-2023';

file = fullfile(TAB_DIR, ...
    'Table_onemodel_allquantiles_w25_method1_for_Antarctic_1960_2023.tex');
...
file = fullfile(TAB_DIR, ...
    'Table_onemodel_allquantiles_w25_method1_fit_Antarctic_1960_2023.tex');
...
save(fullfile(RES_DIR,'RDOS_FOR_allQ_method1_w25_Antarctic_1960_2023.mat'), ...
    'RDOS_FOR');

save(fullfile(RES_DIR,'RDOS_FIT_allQ_method1_w25_Antarctic_1960_2023.mat'), ...
    'RDOS_FIT');

fprintf('\nDensity forecast method1 completed for Antarctic.\n');
