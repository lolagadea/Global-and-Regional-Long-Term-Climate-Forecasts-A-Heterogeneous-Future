% ========================================================================
% run_forecast_Antarctic.m
% ------------------------------------------------------------------------
% Forecast competition for Antarctic temperature distribution characteristics.
...
THIS_DIR     = fileparts(mfilename('fullpath'));   % .../03_Regional/Forecast/Antarctic
...
for j = 1:length(w)
    ...
    for i = 1:length(h)
        ...
        fprintf('\nRunning Antarctic: window = %d, horizon = %d\n', w(j), h(i));
...
OUT_FILE = fullfile(RES_DIR,'RDOS_Antarctic_1960_2023.mat');
save(OUT_FILE,'RDOS');
...
fprintf('\nForecast competition completed for Antarctic.\n');
