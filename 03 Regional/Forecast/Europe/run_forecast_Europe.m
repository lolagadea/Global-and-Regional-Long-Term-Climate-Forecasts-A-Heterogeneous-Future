% ========================================================================
% run_forecast_Europe.m
% ------------------------------------------------------------------------
% Forecast competition for Europe temperature distribution characteristics.
...
THIS_DIR     = fileparts(mfilename('fullpath'));   % .../03_Regional/Forecast/Europe
...
for j = 1:length(w)
    ...
    for i = 1:length(h)
        ...
        fprintf('\nRunning Europe: window = %d, horizon = %d\n', w(j), h(i));
...
OUT_FILE = fullfile(RES_DIR,'RDOS_Europe_1960_2023.mat');
save(OUT_FILE,'RDOS');

% Move auxiliary .dat outputs generated by legacy functions to Results
...
fprintf('\nForecast competition completed for Europe.\n');
