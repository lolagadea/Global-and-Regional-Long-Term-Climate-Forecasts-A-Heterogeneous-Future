% ========================================================================
% compute_weights_BIC_Europe.m
% ------------------------------------------------------------------------
% Compute BIC weights for Europe temperature characteristics.
...
%
% Outputs:
%   03_Regional/Forecast/Europe/Results_for/Weights_BIC_Europe.dat
%   03_Regional/Forecast/Europe/Results_for/BIC_Europe.dat
% ========================================================================
...
save(fullfile(OUT_RES_DIR,'Weights_BIC_Europe.dat'),'W','-ASCII');
save(fullfile(OUT_RES_DIR,'BIC_Europe.dat'),'SBIC','-ASCII');