% ========================================================================
% compute_weights_BIC_Arctic.m
% ------------------------------------------------------------------------
% Compute BIC weights for Arctic temperature characteristics.
...
%
% Outputs:
%   03_Regional/Forecast/Arctic/Results_for/Weights_BIC_Arctic.dat
%   03_Regional/Forecast/Arctic/Results_for/BIC_Arctic.dat
% ========================================================================
...
save(fullfile(OUT_RES_DIR,'Weights_BIC_Arctic.dat'),'W','-ASCII');
save(fullfile(OUT_RES_DIR,'BIC_Arctic.dat'),'SBIC','-ASCII');