% ========================================================================
% main_density_forecast_Pareto_allQ_w25_method0_Arctic.m
% ------------------------------------------------------------------------
% Density forecasts using Pareto-superior models, all selected quantiles.
% Region: Arctic. Window: w = 25. Method 0.
% ========================================================================
...
tableCaption = ['Long-term density forecast with Pareto superior model ' ...
    'for all quantiles (Arctic, CRU data, 1960--2023, w=25, method0)'];

tableLabel = 'tab-Pareto-one-model-all-quantiles-method0-Arctic-1960-2023';

file = fullfile(TAB_DIR, ...
    'Table_onemodel_allquantiles_w25_method0_for_Arctic_1960_2023.tex');
...
file = fullfile(TAB_DIR, ...
    'Table_onemodel_allquantiles_w25_method0_fit_Arctic_1960_2023.tex');
...
save(fullfile(RES_DIR,'RDOS_FOR_allQ_method0_w25_Arctic_1960_2023.mat'), ...
    'RDOS_FOR');

save(fullfile(RES_DIR,'RDOS_FIT_allQ_method0_w25_Arctic_1960_2023.mat'), ...
    'RDOS_FIT');

fprintf('\nDensity forecast method0 completed for Arctic.\n');
