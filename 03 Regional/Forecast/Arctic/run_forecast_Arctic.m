% ========================================================================
% run_forecast_Arctic.m
% ------------------------------------------------------------------------
% Forecast competition for Arctic temperature distribution characteristics.
...
THIS_DIR     = fileparts(mfilename('fullpath'));   % .../03_Regional/Forecast/Arctic
...
for j = 1:length(w)
    ...
    for i = 1:length(h)
        ...
        fprintf('\nRunning Arctic: window = %d, horizon = %d\n', w(j), h(i));
...
OUT_FILE = fullfile(RES_DIR,'RDOS_Arctic_1960_2023.mat');
save(OUT_FILE,'RDOS');
...
fprintf('\nForecast competition completed for Arctic.\n');
