% ========================================================================
% analysis_GW_all_quantiles_Arctic.m
% ------------------------------------------------------------------------
% Giacomini-White pairwise forecast comparison tests for Arctic.
% Replication package IJF - Regional Forecast module.
%
% Inputs:
%   03_Regional/Introduction/Results/QUANTILES_monthly_1960_2023.mat
%   03_Regional/Forecast/Arctic/Results_for/RDOS_Arctic_1960_2023.mat
%
% Outputs:
%   03_Regional/Forecast/Arctic/Results_for/GW_rdos_for*_w25_all_quantiles.mat
% ========================================================================
...
RDOS_FILE  = fullfile(OUT_RES_DIR,'RDOS_Arctic_1960_2023.mat');
...
assert(exist(RDOS_FILE,'file')==2, ...
    'RDOS_Arctic_1960_2023.mat not found in Arctic/Results.');

load(QUANT_FILE,'QUANTILES_monthly','name_labels');
load(RDOS_FILE,'RDOS');

Z = QUANTILES_monthly.APC;
...
for wi = 1:length(W)
    ...
    for fi = 1:length(F)
        ...
        fprintf('GW tests: Arctic, window = %d, horizon = %d\n', w, f);
