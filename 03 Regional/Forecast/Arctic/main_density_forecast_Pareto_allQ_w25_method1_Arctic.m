% ========================================================================
% main_density_forecast_Pareto_allQ_w25_method1_Arctic.m
% ------------------------------------------------------------------------
% Density forecasts using Pareto-superior models, all selected quantiles.
% Region: Arctic. Window: w = 25. Method 1.
% ========================================================================
...
RDOS_FILE = fullfile(RES_DIR,'RDOS_Arctic_1960_2023.mat');
BIC_FILE  = fullfile(RES_DIR,'BIC_Arctic.dat');
...
assert(isfile(RDOS_FILE),   'RDOS_Arctic_1960_2023.mat not found.');
assert(isfile(BIC_FILE),    'BIC_Arctic.dat not found.');
...
QUANTILES = QUANTILES_monthly.APC;
RDOS_run_comp = RDOS;
...
for j = 1:length(W)
    ...
    for i = 1:length(F)
        ...
        for q = 1:length(Q)
            ...
            fprintf('Method 1: Arctic, h=%d, quantile index=%d\n',f,Q(q));
...
tableCaption = ['Long-term density forecast with Pareto superior model ' ...
    'for all quantiles (Arctic, CRU data, 1960--2023, w=25, method1)'];

tableLabel = 'tab-Pareto-one-model-all-quantiles-method1-Arctic-1960-2023';

file = fullfile(TAB_DIR, ...
    'Table_onemodel_allquantiles_w25_method1_for_Arctic_1960_2023.tex');
...
file = fullfile(TAB_DIR, ...
    'Table_onemodel_allquantiles_w25_method1_fit_Arctic_1960_2023.tex');
...
save(fullfile(RES_DIR,'RDOS_FOR_allQ_method1_w25_Arctic_1960_2023.mat'), ...
    'RDOS_FOR');

save(fullfile(RES_DIR,'RDOS_FIT_allQ_method1_w25_Arctic_1960_2023.mat'), ...
    'RDOS_FIT');

fprintf('\nDensity forecast method1 completed for Arctic.\n');
