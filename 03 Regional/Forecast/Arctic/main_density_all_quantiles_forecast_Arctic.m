% ========================================================================
% main_density_all_quantiles_forecast_Arctic.m
% ------------------------------------------------------------------------
% Selection of Pareto-superior models for the density forecast exercise
% using all selected quantiles for Arctic.
% ========================================================================
...
assert(isfile(RDOS_FILE), ...
    'RDOS_Arctic_1960_2023.mat not found.');
...
for j = 1:length(W)
    ...
    for i = 1:length(F)
        ...
        fprintf('Density GW tests: Arctic, window = %d, horizon = %d\n',w,f);
...
save(fullfile(RES_DIR,'selected_model_allQ_Arctic.mat'), ...
